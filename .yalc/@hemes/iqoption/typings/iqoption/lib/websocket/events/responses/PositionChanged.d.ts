...
export declare type PositionStatus = 'open' | 'closed' | string;
export declare type PositionCloseReason = 'win' | 'loose' | 'expired';
...
export declare class PositionChangedResponse extends Response<Position> {
    get name(): string;
}
//# sourceMappingURL=PositionChanged.d.ts.map